...
public class VentanaInicio extends JFrame implements ActionListener{
	...
	public VentanaInicio () {
		...
		panelCirculo.setBackground(Color.PINK);
		...
		panelElipse.setBackground(Color.magenta);
		...
		panelRombo.setBackground(Color.cyan);
		...
		panelCono.setBackground(Color.magenta);
		...
		panelPiramide.setBackground(Color.PINK);
